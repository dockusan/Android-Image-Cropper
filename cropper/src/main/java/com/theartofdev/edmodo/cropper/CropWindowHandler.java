...
final class CropWindowHandler {
    ...
    public Path getPath(CropImageView.CropShape cropShape) {
        mPath.reset();
        switch (cropShape) {
            case RECTANGLE:
                break;
            case OVAL:
                mPath.addPath(PathUtils.generateOvalPath(getRect(), mPath));
                break;
            case TRIANGLE:
                mPath.addPath(PathUtils.generateTrianglePath(getRect(), mPath));
                break;
            case HEART:
                mPath.addPath(PathUtils.generateHeartPath(getRect(), mPath));
                break;
            case STAR:
                mPath.addPath(PathUtils.generateStarPath(getRect(), mPath));
                break;
        }
        return mPath;
    }
